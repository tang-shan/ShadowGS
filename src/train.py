...
if __name__ == "__main__":
    ...
    parser.add_argument("--robust_config", type=str, default="robust_config.json")
    ...
    with open(args.robust_config, 'r') as file:
    ...
    training(lp.extract(args), op.extract(args), pp.extract(args), robust_params, args.test_iterations, args.save_iterations, args.checkpoint_iterations, args.start_checkpoint, args.debug_from)
